...
import svgPaths from "./svg-hamg4btugb";
...
function ContainerText({ text, blurName = false }: ContainerTextProps) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <div
        className={clsx(
          "flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#252c32] text-[14px] whitespace-nowrap",
          blurName && "blur-sm select-none",
        )}
      >
        <p className="leading-[20.02px]">{text}</p>
      </div>
                    ...
                    >
                      ...
                      >
                        <Wrapper2 additionalClassNames="relative shrink-0">
                          <g clipPath="url(#clip0_20_8390)" id="joystick.svg">
                            <path
                              d={svgPaths.pe978800}
                              fill="var(--fill-0, black)"
                              id="Vector"
                ...
                <Container1>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Wrapper2 additionalClassNames="relative shrink-0">
                          <g clipPath="url(#clip0_20_8366)" id="shuttle.svg">
                            <path
                              d={svgPaths.p260f680}
                              fill="var(--fill-0, black)"
                              id="Vector"
                ...
                <Container1>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Wrapper2 additionalClassNames="relative shrink-0">
                          <g clipPath="url(#clip0_20_8386)" id="settings.svg">
                            <path
                      ...
                      >
                        ...
                        >
                          <div className="absolute inset-0 overflow-hidden pointer-events-none">
                            <img
                              alt=""
                              className="absolute h-[150%] left-0 max-w-none top-[-25%] w-full"
                              src={imgSabrina}
                            />
                          </div>
                        </div>
